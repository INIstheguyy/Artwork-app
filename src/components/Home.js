...
import sales from './assets/images/art-sales.jpg'
import consult from './assets/images/art-consult.png'
        ...
        <div>
                ...
                <div className=" flex items-center justify-center min-h-screen p-2 rounded-lg  ">
                   <span className=" bg-[#E7F6F2] z-50 p-10 ">
                    <div className=" text-center ">
                        ...
                        <p className=" text-[#A5C9CA] font-sans py-5 md:px-5">
                        ...
                        <p className=" py-5 text-[#A5C9CA] font-sans text-justify md:px-5">
            ...
            <h1 className="  text-center py-[10px] text-[#E7F6F2] font-heading2 font-semibold lg:text-[34px] lg:py-[19px] pl-1 text-[18px] leading-[19px] tracking-[2.7px]">The Services we offer.</h1>
                  <div className=" flex flex-col flex-1 md:flex-row flex-wrap justify-around items-center py-3 md:py-10 ">
                    ...
                    <div className="">
                    <Card imageSrc={consult} title={services.two.name} description={services.two.text}/>
                    </div>
                    <div className="">
                    <Card imageSrc={reps} title={services.three.name} description={services.three.text}/>
                    </div>
                  </div>  
            </section>
